...
SITE_CODE = "sw"
FAMILY = "wikipedia"
REPORT_PAGE = "Maalum:MarejeoMadogo"
DRY_RUN = False
LIMIT = 50
...
def has_image_markup(wikitext: str) -> bool:
    return bool(re.search(r"\[\[(?:File|Image):", wikitext, flags=re.IGNORECASE))
    ...
    try:
        ...
        for claim in claims:
            ...
            if isinstance(target, str) and target.strip():
                ...
                insertion = f"[[File:{filename}|thumb|upright=1.1]]\n\n"
                return insertion + wikitext.lstrip(), True
    except Exception:
        return wikitext, False
    return wikitext, False
